...
export default function Footer({ categories = [], siteSettings = null, certificates = [] }: { categories?: { slug: string; name: string }[], siteSettings?: SiteSettings | null, certificates?: Certificate[] }) {
              ...
              {certificates.length > 0 && (
                <Link 
                  ...
                  style={{
                    ...
                    padding: '8px 12px', background: 'rgba(212,160,90,0.1)', 
                    border: '1px solid rgba(212,160,90,0.3)', borderRadius: 6,
                    color: '#d4a05a', fontSize: '0.8rem', fontWeight: 600, 
                    textDecoration: 'none', transition: 'all 0.2s', marginTop: 6, marginBottom: 16
                  }}
                  onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(212,160,90,0.2)'; e.currentTarget.style.borderColor = 'rgba(212,160,90,0.5)'; }}
                  onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(212,160,90,0.1)'; e.currentTarget.style.borderColor = 'rgba(212,160,90,0.3)'; }}
                >
                  <span style={{ fontSize: '1rem' }}>✓</span> Certificates of Authenticity
                </Link>
              )}
            ...
            <div className={styles.footerCol}>
              ...
              <ul className={styles.footerLinks}>
                ...
                <li className={styles.footerContactItem}>
                  ...
                  <a href="mailto:sales@moortiindia.com" className={styles.footerLink}>
